        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
            <div className="aspect-[3/4] md:aspect-square bg-slate-200 overflow-hidden relative z-10 shadow-2xl">
              <img 
                src="https://i.ibb.co/67qSS9k1/image-1.jpg" 
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="flex items-center gap-8">
                <div>
                    <p className="text-3xl font-bold text-slate-900">2023</p>
                    <p className="text-xs text-slate-500 uppercase tracking-wider">
                      {language === 'ro' ? 'Debut Divin' : 'Divine Debut'}
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p className="text-xs text-slate-500 uppercase tracking-wider">
                      {language === 'ro' ? 'Piese Unice' : 'Unique Pieces'}
                    </p>
                </div>
                <div className="w-[1px] h-12 bg-slate-200" />
                <div>
                    <p className="text-3xl font-bold text-slate-900">Steel</p>
                    <p className="text-xs text-slate-500 uppercase tracking-wider">
                      {language === 'ro' ? 'Sudat Manual' : 'Hand Welded'}
                    </p>
                </div>
            </div>
          </div>
